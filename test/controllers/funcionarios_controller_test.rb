...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post funcionarios_url, params: { funcionario: { email: @funcionario.email, name: @funcionario.name, password: @funcionario.password } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { email: @funcionario.email, name: @funcionario.name, password: @funcionario.password } }
