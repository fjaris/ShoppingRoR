...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, foto: @produto.foto, name: @produto.name, preco: @produto.preco } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { categoria: @produto.categoria, descricao: @produto.descricao, foto: @produto.foto, name: @produto.name, preco: @produto.preco } }
